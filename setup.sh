...
declare -r -a FILES=("$SCRIPT_DIR/p13390677_112040_Linux-x86-64_1of7.zip" "$SCRIPT_DIR/p13390677_112040_Linux-x86-64_2of7.zip")
...
yum -y install oracle-rdbms-server-11gR2-preinstall unzip
